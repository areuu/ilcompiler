...
val build_test_instanceof_op : var -> var -> builder -> (var * inst)
val build_test_in_op : var -> var -> builder -> (var * inst)
...
val build_loop_break_op : builder -> inst
val build_switch_break_op : builder -> inst
